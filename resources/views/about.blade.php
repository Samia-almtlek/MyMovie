<x-app-layout>
    <div style="background-color: #000000; color: #FFFFFF; padding: 2rem; min-height: 100vh;">
        ...
        <p style="color: #B3B3B3; font-size: 1.5rem; line-height: 2; margin-top: 1.5rem;">
            Our mission is to create a unique space where movie lovers can immerse themselves in the art of filmmaking.
            Here, you'll find:
        </p>
        ...
        <ul style="color: #B3B3B3; font-size: 1.5rem; line-height: 2; margin-left: 2rem; list-style: disc;">
            ...
            <li><strong>Community Engagement:</strong> Share your thoughts by commenting on posts, exchanging ideas, and
                debating the latest releases.</li>
            <li><strong>Movie Stories:</strong> Dive into the fascinating world of cinema with behind-the-scenes
                details,
                trivia, and stories that bring your favorite movies to life.</li>
            <li><strong>Interactive Discussions:</strong> Engage with other users to discuss your opinions on movies,
        ...
        <p style="color: #B3B3B3; font-size: 1.5rem; line-height: 2; margin-top: 1.5rem;">
            ...
            posts,
            sharing their views, and fostering lively discussions.
        </p>

        <p style="color: #B3B3B3; font-size: 1.5rem; line-height: 2; margin-top: 1.5rem;">
            Whether you're searching for the next blockbuster to watch, exploring the nuances of your all-time favorite
            classics, or simply looking to connect with a vibrant movie-loving community, <strong>My Movie</strong> is
            the
            perfect place for your cinematic journey.
        </p>
    </div>
</x-app-layout>